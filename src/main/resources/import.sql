INSERT INTO BUILDING(id,name,outside_temperature) VALUES (-9,'building A' ,15);
INSERT INTO BUILDING(id,name,outside_temperature) VALUES (-10, 'building C',10);

INSERT INTO ROOM(id, name, floor, current_temperature, target_temperature, building_id) VALUES(-10, 'Room1', 1, 22.3, 20.0,-9);
INSERT INTO ROOM(id, name, floor,current_temperature, target_temperature, building_id) VALUES(-9, 'Room2', 1,17.5,22.1,-10);
